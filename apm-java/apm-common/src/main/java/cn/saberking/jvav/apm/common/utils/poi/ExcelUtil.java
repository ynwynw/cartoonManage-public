package cn.saberking.jvav.apm.common.utils.poi;

import cn.saberking.jvav.apm.common.annotation.Excel;
import cn.saberking.jvav.apm.common.annotation.Excels;
...
import cn.saberking.jvav.apm.common.utils.DictUtils;
import cn.saberking.jvav.apm.common.utils.StringUtils;
import cn.saberking.jvav.apm.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
            ...
            for (int i = 1; i < rows; i++) {
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet()) {
                    ...
                    if (String.class == fieldType) {
                        ...
                        if (StringUtils.isNumeric(Convert.toStr(val))) {
        ...
        try {
            ...
            if (attr.isExport()) {
                ...
                if (StringUtils.isNotEmpty(dateFormat) && StringUtils.isNotNull(value)) {
                    ...
                    /*jdk8用：cell.setCellValue((((BigDecimal) value).setScale(attr.scale(), attr.roundingMode())).toString());*/
                    cell.setCellValue((((BigDecimal) value).setScale(attr.scale(), RoundingMode.HALF_UP)).toString());
                } else {
                    // 设置列类型
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = ApmConfig.getDownloadPath() + filename;
